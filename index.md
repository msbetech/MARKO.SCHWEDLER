...
•	Refactoring
•	Durchführung von Code-Remediation (ATC-Checks, Anpassung an S/4HANA-Kompatibilität) / Implementierung von Clean ABAP in die Entwicklungsumgebung
•	SAP-Schnittstellenentwicklung (IDoc, RFC, OData, EDI, SEGW)
•	Webservices / Schnittstellen mit OData
...
•	CDS-Views / OData / Fiori
•	ABAP-Objects (in ADT)
•	ABAP-Doc / ABAP-Unit
•	ATC / Code Inspector / Clean ABAP
•	SAP-Logistik
•	SAP S/4HANA Migration Cockpit(MC)
•	SAP-Datenmigrationen
•	SAP IDOC / ALE / RFC / Badi / User-Exit / EDI / REST / SEGW
•	SAP SAPScript / Smartforms
•	SQL
•	SOLID
